    ...
    <div className="flex flex-col gap-1">
      ...
      <div className="relative">
        ...
        <button
          ...
          className="absolute inset-y-0 right-0 flex w-10 items-center justify-center rounded-sm text-ink-muted transition-quiet hover:text-ink disabled:opacity-60"
        >
          {isVisible ? (
